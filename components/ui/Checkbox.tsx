export function Checkbox({
  ...
  return (
    <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-line bg-white/60 p-4 text-left transition-colors hover:border-brand-600">
      <input
        id={id}
        type="checkbox"
        checked={checked}
